...
from cudaqvanillasimulation import cudaq_simulation, noisy_cudaq_simulation
...
# ============================================================
# Unified benchmarking driver for QAOA Vanilla Proxy benchmarks
# ============================================================

def run_benchmark(benchmark: CudaQBenchmark, noise_levels=[0.0, 0.005, 0.02]):
    """Runs ideal + noisy simulations for a CUDA-Q QAOA Vanilla Proxy benchmark."""
...
if __name__ == "__main__":
    ...
    for num_qubits in [3, 4, 5]:
        benchmark = QAOAVanillaProxy_CUDAQ(num_qubits)

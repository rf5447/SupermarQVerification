...
def noisy_cudaq_simulation(kernel, num_qubits: int, time_step: int, total_time: int, p: float, shots=1000):
    """
    ...
    return cudaq.sample(kernel, num_qubits, time_step, total_time, noise_model=noise, shots_count=shots)


def cudaq_simulation(kernel, num_qubits: int, time_step: int, total_time: int, shots=1000):
    return cudaq.sample(kernel, num_qubits, time_step, total_time, shots_count=shots)

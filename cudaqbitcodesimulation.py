...
def noisy_cudaq_simulation(kernel, num_data_qubits: int, num_rounds: int, bit_state: list[int], p: float, shots=1000):
    """
    ...
    return cudaq.sample(kernel, num_data_qubits, num_rounds, bit_state, noise_model=noise, shots_count=shots)


def cudaq_simulation(kernel, num_data_qubits: int, num_rounds: int, bit_state: list[int], shots=1000):
    return cudaq.sample(kernel, num_data_qubits, num_rounds, bit_state, shots_count=shots)
